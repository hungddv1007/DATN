...
public interface UserRepository extends JpaRepository<User, Integer> {
    ...
    /**
     * Khóa hàng user trong suốt transaction để các thao tác thay đổi gói tập
     * của cùng một member không thể vượt qua bước kiểm tra đồng thời.
     */
    @Lock(LockModeType.PESSIMISTIC_WRITE)
    @Query("SELECT u FROM User u WHERE u.email = :email")
    Optional<User> findByEmailForMembershipUpdate(@Param("email") String email);
